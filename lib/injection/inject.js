  ...
  w.__SF = (function(site){
    var helpers = {
        ...
        elementsWithClassOrId : function(){
          return document.querySelectorAll("*[id], *[class]").length;
        },
        listIDs : function(){
      ...
      addSelectors = function(array){
        site["used selectors"] = site["used selectors"].concat(helpers.uniquify(array));
      },
      tally = function(){
        ...
        site.summary  = tot;
        site.document = dom;
        site["used selectors"] = helpers.uniquify(site["used selectors"]);
      },
      findFrameworks = function(){
        ...
        var frameworks =
          {// get unique identifiers from lib/frameworks/unique.json by running the frameworks.js module
          ...
          fwkNames = Object.keys(frameworks),
          found = {},
          frameworkCheck = function(selectors){
            fwkNames.map(function(f){
              var ids = frameworks[f].length,
                matches=0;
              frameworks[f].map(function(id){
        ...
        site["frameworks"] = frameworkCheck(Object.keys(site["selectors"]));
      };
    return {
