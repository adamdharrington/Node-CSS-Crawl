  ...
  w.__SF = (function(site){
    ...
    addSelector = function(st, si, ri, pl){
      if(site.selectors.hasOwnProperty(st)){
        ...
        // TODO: search pseudo elements as elements
        var qs = w.document.querySelectorAll(st).length || 0;
